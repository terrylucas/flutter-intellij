...
public class FlutterStudioMonitorStageView extends FlutterStageView<FlutterStudioMonitorStage> {
  ...
  //private final List<FlutterProfilerMonitorView> myViews;

  public FlutterStudioMonitorStageView(@NotNull FlutterStudioProfilersView profilersView, @NotNull FlutterStudioMonitorStage stage) {
    ...
    for (ProfilerMonitor monitor : stage.getMonitors()) {
      ...
      //ontextMenuInstaller contextMenuInstaller = ideProfilerComponents.createContextMenuInstaller();
    ...
    */
    ...
    RangedContinuousSeries usedMemoryRange = new RangedContinuousSeries("Memory", getTimeline().getViewRange(), new Range(0, 1024 * 1024 * 100), memoryUsedDataSeries);
    RangedContinuousSeries maxMemoryRange = new RangedContinuousSeries("MemoryMax", getTimeline().getViewRange(), new Range(0, 1024 * 1024 * 100), memoryMaxDataSeries);
    ...
    mLineChart.configure(usedMemoryRange, new LineConfig(new JBColor(new Color(0x56BFEC), new Color(0x2B7DA2))).setFilled(true).setStacked(true).setLegendIconType(LegendConfig.IconType.BOX));
    mLineChart.configure(maxMemoryRange, new LineConfig(new JBColor(new Color(0x1B4D65), new Color(0xF6F6F6))).setStroke(LineConfig.DEFAULT_DASH_STROKE).setLegendIconType(LegendConfig.IconType.DASHED_LINE));
